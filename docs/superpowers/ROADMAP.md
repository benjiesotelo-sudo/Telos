...
|---|---|---|---|---|
| 1 | ANOVA family | ~10: one-way + post-hoc, factorial, RM, nested, mixed, ANCOVA, MANOVA, MANCOVA, Kruskal-Wallis, Friedman | ~1 | sphericity + post-hoc adjustments get heavy verification |
| 2 | Association | ~6: Pearson, Spearman, Kendall, χ² ×2, Fisher | ~0.5 | most pattern-following slice |
| 3 | Regression & prediction | ~4: simple, multiple, logistic, Poisson/neg-bin | ~1 | bigger output tables |
| 4 | Econometrics | ~11: ARIMA, ADF/KPSS, Granger, VAR, FE/RE, Hausman, DiD, RDD, IV, PSM | ~1.5–2 | **main risk: package availability under WebR** — spike first |
| 5 | Latent variables & SEM | ~7: alpha, AVE/CR, EFA, PCA, CB-SEM, PLS-SEM, mediation (R1) | ~2–3 | AMOS-style canvas = new UI surface; full review gauntlet per owner ruling |
| 6 | Report & export | PDF report, LaTeX, R script, LICENSES in bundle | ~1–2 | client-side APA-7 PDF generation |
| 7 | Polish & launch | design pass, DRAFT copy confirmations, B-list, feedback URL, analytics, licence, a11y, deploy | ~1 | mostly owner decisions |
