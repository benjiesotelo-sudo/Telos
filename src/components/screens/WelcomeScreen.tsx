...
import { TelosMark } from '../TelosMark'
...
export function WelcomeScreen() {
  ...
  return (
    <section style={{ textAlign: 'center', paddingTop: 40 }}>
      ...
      {/* W1 wordmark (brand kit, cleanup slice 2026-07-11): Crimson Pro at weight 620 with the clay
        * full stop - the wordmark is live text, never an image (docs/brand/README.md). */}
      ...
      {/* The tuned three-node mark replaces the placeholder settling-curve gesture (same enter-3 slot). */}
      <div className="enter-3" style={{ margin: '18px auto 6px' }}>
        <TelosMark width={118} />
      </div>
