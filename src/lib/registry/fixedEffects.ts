...
// §2.8 econometrics-grade addition: poolability F-test (plm::pFtest) — surfaced as a builder-constructed note
// (the drawn card has no table note); not in the HTML, flagged for ratify.
