...
import { FIXED_EFFECTS as spec } from './fixedEffects'
...
const card = sliceTo(outputsHtml, '<span class="rt-name">Fixed effects</span>', '<span class="rt-name">')
const inputsHtml = readFileSync('telos_test_inputs.html', 'utf8')
const inCard = sliceTo(inputsHtml, '<div class="ttl">Fixed effects</div>', '<div class="ttl">')

describe('fixed-effects registry stays faithful to the spec HTML (verbatim, card-scoped)', () => {
