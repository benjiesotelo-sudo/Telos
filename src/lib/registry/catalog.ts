...
export const CATALOG: CatalogEntry[] = [
  ...
  e('frequencies-crosstabs', 'Frequencies & cross-tabs', 'Descriptive statistics', undefined, 'available', 'Frequencies'),
  e('distribution-normality', 'Distribution & normality', 'Descriptive statistics', undefined, 'available', 'Normality'),
  ...
  e('one-way-anova', 'One-way ANOVA + post-hoc', 'Group comparisons', 'Parametric', 'available', 'One-way ANOVA'),
  e('factorial-anova', 'Factorial ANOVA', 'Group comparisons', 'Parametric', 'available'),
  e('repeated-measures-anova', 'Repeated-measures ANOVA', 'Group comparisons', 'Parametric', 'available', 'RM ANOVA'),
  ...
  e('wilcoxon-signed-rank', 'Wilcoxon signed-rank', 'Group comparisons', 'Nonparametric', 'available', 'Wilcoxon'),
  ...
  e('chi-square-independence', 'Chi-square independence', 'Association', 'Categorical', 'available', 'χ² independence'),
  ...
  e('stationarity-tests', 'Stationarity tests (ADF, KPSS)', 'Econometrics', 'Time series', 'available', 'ADF / KPSS'),
  ...
  e('did', 'Difference-in-differences (DiD)', 'Econometrics', 'Causal inference', 'available', 'DiD'),
  e('rdd', 'Regression discontinuity (RDD)', 'Econometrics', 'Causal inference', 'available', 'RDD'),
  e('iv-2sls', 'Instrumental variables (IV / 2SLS)', 'Econometrics', 'Causal inference', 'available', 'IV / 2SLS'),
  e('propensity-score-matching', 'Propensity score matching', 'Econometrics', 'Causal inference', 'available', 'PSM'),
  e('cronbachs-alpha', "Cronbach's alpha", 'Latent variable models', 'Reliability', 'available'),
  e('ave', 'Average variance extracted (AVE)', 'Latent variable models', 'Reliability', 'available', 'AVE'),
