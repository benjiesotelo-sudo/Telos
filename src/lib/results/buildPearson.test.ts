...
const res: PearsonResult = { varA: 'hours_studied', varB: 'exam_score',
  r: 0.61234, t: 4.7789, df: 38, p: 0.0000271, ciLow: 0.3712, ciHigh: 0.7741, n: 40, ciLevel: 0.95, alpha: 0.05, tails: 'two.sided', nExcluded: 0, figurePng: png }
...
describe('buildPearson', () => {
  ...
  it('values carries the numbers the term explainer references (U8-T3/U8-T4)', () => {
    const c = buildPearson(PEARSON, res)
    expect(c.values).toEqual({ df: '38', r: '.61', ciLow: '.37', ciHigh: '.77', ci: '[.37, .77]', ciPct: 95, t: '4.78', p: '< .001', n: 40 })
  })
})
