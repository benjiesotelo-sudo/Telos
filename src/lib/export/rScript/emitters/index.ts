...
export const EMITTERS: Record<string, Emitter> = { ...regressionEmitters, ...groupEmitters, ...assocDescEmitters }
export const PACKAGES: Record<string, string[]> = { ...regressionPackages, ...groupPackages, ...assocDescPackages }
